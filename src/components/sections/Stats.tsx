...
const stats = [
  ...
  { num: "2", label: "Countries", desc: "Serving students in India and UAE — live online, no commute" },
  { num: "1", label: "NDTV Feature", desc: "Our founder was featured on NDTV for teaching engineers at age 11" },
];
